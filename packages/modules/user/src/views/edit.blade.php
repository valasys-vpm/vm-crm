                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-user-edit" method="post" action="{{ route('user.update', base64_encode($resultUser->id)) }}">
                                                        @csrf
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                ...
                                                                <input type="email" class="form-control btn-square" id="email" name="email" value="{{ $resultUser->email }}" placeholder="Enter email">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                ...
                                                                <input type="text" class="form-control btn-square text-uppercase" id="emp_code" name="emp_code" value="{{ $resultUser->userDetail->emp_code }}" placeholder="Enter employee code">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                                <label for="department">Department<span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control btn-square" id="department" name="department" value="{{ $resultUser->userDetail->department }}" placeholder="Enter department">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                                <label for="designation">Designation<span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control btn-square" id="designation" name="designation" value="{{ $resultUser->userDetail->designation }}" placeholder="Enter designation">
                                                            </div>
                                                            <div class="col-md-6 form-group">
...
@section('javascript')
    ...
    <script>
        $("#role_id").val('{{$resultUser->role_id}}');
        $("#reporting_manager_id").val('{{$resultUser->userDetail->reporting_manager_id}}');
                    ...
                    'email' : {
                        ...
                        remote : {
                            ...
                            data : {
                                ...
                                user_id : '{{ base64_encode($resultUser->id) }}'
                            }
                        }
                    },
                    'emp_code' : {
