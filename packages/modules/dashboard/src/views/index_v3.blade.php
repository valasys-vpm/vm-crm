                                        ...
                                        <div class="card card-customer shadow" style="margin-bottom: 2px;">
                                            <div class="card-block" style="padding: 10px 25px !important;">
                                                <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <div class="col-auto">
                                                        @switch($status)
                                                            @case('Live') <i class="feather icon-play f-20 text-white bg-success shadow"></i> @break
                                                            @case('Paused') <i class="feather icon-pause f-20 text-white bg-warning shadow"></i> @break
                                                            @case('Cancelled') <i class="feather icon-x f-20 text-white bg-danger shadow"></i> @break
                                                            @case('Delivered') <i class="feather icon-check f-20 text-white bg-info shadow"></i> @break
                                                            @case('Reactivated') <i class="feather icon-refresh-cw f-20 text-white bg-success shadow"></i> @break
                                                            @case('Shortfall') <i class="feather icon-chevrons-down f-20 text-white bg-secondary shadow"></i> @break
                                                        @endswitch
                                                    </div>
                                                </div>
                                            </div>
