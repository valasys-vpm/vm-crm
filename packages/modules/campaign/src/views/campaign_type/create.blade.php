                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Add New Campaign Type</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <h5>Add New Campaign Type</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-campaign-type-create" method="post" action="{{ route('campaign_type.store') }}">
                                                        @csrf
                                                        <div class="row">
...
@section('javascript')
    ...
    <script>
        $(function(){
            $("#form-campaign-type-create").validate({
                focusInvalid: false,
                rules: {
                    'name' : {
                        required : true,
