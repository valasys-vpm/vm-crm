    ...
    <script>
        ...
        $(function(){
            ...
            $('body').on('keyup', ".sub-allocation",function () {
                ...
                if(total > parseInt($("#txt_allocation").val())) {
                    $(this).val('');
                    $(this).keyup();
                }
        ...
        function editLeadDetails(lead_id,start_date, end_date, deliver_count, allocation, campaign_status, shortfall_count) {
            $('#start_date').bootstrapMaterialDatePicker('setDate', new Date(start_date));
            $('#end_date').bootstrapMaterialDatePicker('setMinDate', new Date(start_date));
            $('#end_date').bootstrapMaterialDatePicker('setDate', new Date(end_date));
