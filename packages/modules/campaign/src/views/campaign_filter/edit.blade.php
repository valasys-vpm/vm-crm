                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Edit Campaign Filter</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <h5>Edit Campaign Filter</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="form-campaign-filter-edit" method="post" action="{{ route('campaign_filter.update', base64_encode($resultCampaignFilter->id)) }}">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-6 form-group">
                                                                <label for="full_name">Name<span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control btn-square" id="full_name" name="full_name" placeholder="Enter name" value="{{ $resultCampaignFilter->full_name }}">
                                                            </div>
                                                            <div class="col-md-6 form-group">
                                                                <label for="name">Abbreviation<span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter abbreviation" value="{{ $resultCampaignFilter->name }}">
                                                            </div>
                                                            <div class="col-md-6 form-group">
...
@section('javascript')
    ...
    <script>
        $("#status").val('{{ $resultCampaignFilter->status }}');
        $(function(){
            $("#form-campaign-filter-edit").validate({
                focusInvalid: false,
                rules: {
                    'name' : {
                        required : true,
                        remote : {
                            ...
                            data : {
                                campaign_filter_id : '{{ base64_encode($resultCampaignFilter->id) }}'
                            }
                        }
                    },
